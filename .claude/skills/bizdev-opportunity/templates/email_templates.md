# Email Templates for BizDev Opportunity Intelligence

Reference templates for drafting outreach emails. Each template follows the edusales-writer pattern: value-first, specific, and helpful rather than salesy.
...
4. **Soft CTA** - Single, low-commitment ask

---

## Cold Email Templates

### Template C1: Pattern Recognition Hook

**Best for:** First contact, high-potential opportunity

```
Subject: Quick thought on {pain_point_short}
...
### Template C2: Mutual Connection Reference

**Best for:** When there's a warm path
...
### Template C3: Direct Value Offer

**Best for:** Clear pain point identified

```
Subject: 5 minutes → 45 minutes (lab reports)
...
### Template W1: Post-Meeting Follow-Up

**Best for:** Within 7 days of conversation
...
### Template W2: Resource Share

**Best for:** When you promised to send something

```
Subject: That {resource} we discussed

{First_name},

As promised, here's {resource description}.

The key sections for your situation:
- {Section 1}: Addresses {pain_point_1}
- {Section 2}: The {specific_topic} framework you asked about
- {Section 3}: Case study similar to {their_situation}

Let me know what resonates. Happy to walk through any of it.

Anant
```

### Template W3: Proposal Follow-Up

**Best for:** After sending proposal, waiting for response
...
### Template R1: Value-Add Return

**Best for:** 30-60 days since contact

```
Subject: Thought of you when...
...
{Specific insight or resource}

Still dealing with {original_challenge}? Happy to share what's working now.

Anant
```

### Template R2: New Development

**Best for:** When you have new features/offerings

```
Subject: Update that might help with {pain_point}
...
### Template R3: Case Study Share

**Best for:** When you have relevant social proof

```
Subject: How {similar_client} solved {pain_point}
...
- [ ] No cliche opening phrases
- [ ] Opens with value or relevance
- [ ] References specific pain point or context
- [ ] Clear connection between their need and my expertise
