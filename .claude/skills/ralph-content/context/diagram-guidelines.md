...
#### 1. NGM Sei × Ma Palette + Warm Linen/Washi Background

Use the NGM Sei × Ma palette from `ngm-style-guide.md` — the same palette the lead magnet HTML uses — for every lead-magnet hero diagram, every hub/network diagram, every LinkedIn/social graphic, and every newsletter diagram. The legacy palette earlier in this file (#F5F2EC, #302C27, #C49A6C — the pre-2026-06 "warm-brown" system) is retired; do not use it.

- linen: `#F3F2EC`, washi/paper: `#FAF9F5`, paper-alt: `#ECEAE2`
- ink: `#232220`, ink-2: `#4A4844`, ink-3: `#76736C`, ink-4: `#A6A39A`
- rule: `#DEDBD2`
- accent (slate): `#3E5A6E`
- pine (positive/benefit): `#4F6B57`
- clay (caution/friction): `#BD6B4E`

The background should be a radial gradient from `#FAF9F5` (center) to `#ECEAE2` (edge) rather than a flat fill. Warm, dimensional, editorial — not clinical white.
...
#### 2. NGM Sei × Ma Typography

Two fonts. Never deviate.

- **Display (titles, deck, subject names, pull quotes):** `'Zen Old Mincho', 'Noto Serif JP', Georgia, serif` — upright only, no italic face exists.
- **Body + UI (kickers, labels, captions, metadata, tables, decks/asides needing italics):** `'Familjen Grotesk', system-ui, sans-serif`. Has true italics — use for decks and asides.

Kickers are uppercase, Familjen Grotesk 11–14px, weight 700, letter-spacing 2–4, accent (slate) color. Titles are Zen Old Mincho at 36–52px for hero diagrams, 22–32px for inline figures. Decks are Familjen Grotesk italic at 18–22px. Labels on shapes are Familjen Grotesk 11–13px.
...
- Stroke the outline at 2–2.5px in accent slate (`#3E5A6E`) for definition. Only use ink for clinical/diagrammatic subjects where the slate accent would feel off (e.g. a diagram about regulatory failure).
...
- **Kicker (mechanistic):** Familjen Grotesk 11px, weight 700, letter-spacing 2, color matching the layout's semantic tone (pine for benefit, clay for caution, slate for neutral/informational or factual). Examples: `mTOR ↓ · AUTOPHAGY ↑`, `NRF2 ↑`, `CYP3A4 INTERACTION`, `PHASE 2 TRIAL · n=107`.
- **Headline (plain-English):** Zen Old Mincho 18–24px (scale with available space), weight 500, ink color. Examples: "Cells clean house", "Antioxidant defenses rise", "Liver clears drugs slower", "Trial missed its primary endpoint".
- **Optional subtitle (specifics):** Familjen Grotesk 11–12px, ink-3 color. One to two lines naming the biomarkers, molecules, populations, or numbers.
...
- **Radial gradients on subjects and backgrounds** (not flat fills). Every focal subject uses a two-to-three-stop radial gradient that suggests lighting. The background itself is a subtle radial gradient from washi center to paper-alt edge.
...
Other polish cues that show up in strong diagrams: dashed guide rings or baselines at low opacity, thin rule lines (1–2px at `#DEDBD2`) separating sections, small terminator dots on connector lines (r=7 at the line's semantic endpoint), generous whitespace around the focal area.
...
- **All spokes share a valence** (all beneficial, or all risks, or all markers) — this makes the radial pine/clay/slate convention coherent.
...
- **Connector + terminator dot + card** per spoke. Connector stroke 2px in the valence color (pine for beneficial, clay for caution, slate for neutral). Terminator dot at node r=7 in the same color. Card: `#FAF9F5` fill, border in valence color at 1.5px.
- **Consistent valence across all spokes.** If all outcomes are beneficial, all connectors are pine. If all outcomes are risks, all connectors are clay. If the spokes mix positive and negative, the Hub Layout is wrong for this content; use Comparison or Cascade instead.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200">
  <defs>
    ...
    <radialGradient id="glow" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#3E5A6E" stop-opacity="0.18"/>
      <stop offset="100%" stop-color="#3E5A6E" stop-opacity="0"/>
    </radialGradient>
  </defs>
  <rect width="1200" height="1200" fill="url(#bg)"/>

  <!-- HEADER: kicker + title + deck -->
  <text x="600" y="70" text-anchor="middle" font-family="Familjen Grotesk" font-size="14" font-weight="700" letter-spacing="4" fill="#3E5A6E">NEXT GENERATION MEDICINE · [TAG]</text>
  <line x1="440" y1="88" x2="760" y2="88" stroke="#DEDBD2" stroke-width="1"/>
  <text x="600" y="148" text-anchor="middle" font-family="Zen Old Mincho" font-size="52" fill="#232220">[Scroll-stopping headline.]</text>
  <text x="600" y="196" text-anchor="middle" font-family="Familjen Grotesk" font-size="22" font-style="italic" fill="#76736C">[One-line elaboration.]</text>
  ...
  <g transform="translate(600,620)">
    ...
    <text y="-10" text-anchor="middle" font-family="Zen Old Mincho" font-size="44" fill="#232220">[SUBJECT NAME]</text>
    <text y="22" text-anchor="middle" font-family="Familjen Grotesk" font-size="13" font-weight="600" letter-spacing="2.5" fill="#3E5A6E">[SUB-LABEL]</text>
    <text y="62" text-anchor="middle" font-family="Familjen Grotesk" font-size="11" font-weight="500" letter-spacing="1.2" fill="#3E5A6E">[MECHANISM HINT]</text>
  </g>

  <!-- Dashed ring guides -->
  <g fill="none" stroke="#DEDBD2" stroke-width="1" opacity="0.5">
  ...
  <!-- Each card: rect fill=#FAF9F5 stroke=#4F6B57, kicker=pine 11px, headline=Zen Old Mincho 20-22px, subtitle=Familjen Grotesk 11-12px -->

  <!-- FOOTER banner -->
  <line x1="80" y1="1085" x2="1120" y2="1085" stroke="#DEDBD2" stroke-width="1"/>
  <text x="80" y="1120" font-family="Familjen Grotesk" font-size="13" font-weight="600" letter-spacing="2" fill="#3E5A6E">[UNIFYING INSIGHT]</text>
  <text x="80" y="1146" font-family="Familjen Grotesk" font-size="12" fill="#76736C">[One-line explainer.]</text>
  <text x="80" y="1170" font-family="Familjen Grotesk" font-size="11" font-style="italic" fill="#A6A39A">[Source citation with DOI and effect size.]</text>
  <text x="1120" y="1120" text-anchor="end" font-family="Familjen Grotesk" font-size="13" font-weight="700" letter-spacing="2" fill="#232220">NGM</text>
  <text x="1120" y="1140" text-anchor="end" font-family="Familjen Grotesk" font-size="10" fill="#76736C">nextgenerationmedicine.co</text>
  <text x="1120" y="1156" text-anchor="end" font-family="Familjen Grotesk" font-size="10" fill="#76736C">Dr. Anant Vinjamoori</text>
</svg>
```
...
```
Title (narrative, Zen Old Mincho): "The [Metaphor Name]"
Subtitle (Familjen Grotesk, small): One-line explanation of the biology
─────────────────────────────────────
Scene(s):
...
--paper: #FAF9F5           /* Washi — USE FOR SVG BACKGROUNDS, never pure white */

/* TEXT & SHAPES */
--ink-900: #232220         /* Primary text, headings, key shapes */
--ink-700: #4A4844         /* Secondary text, body copy */
--ink-500: #76736C         /* Tertiary text, labels */
--ink-400: #A6A39A         /* Subtle text, annotations */

/* LINES & BORDERS */
--line: #DEDBD2            /* Borders, dividers, connecting lines */

/* ACCENTS (use sparingly - max 5-10% of visual area) */
--accent: #3E5A6E          /* Primary accent — slate */
--clay: #BD6B4E            /* Warnings, negative states, emphasis, caution */
--pine: #4F6B57            /* Positive states, success, growth */
```
...
<defs>
  <linearGradient id="slateGrad" x1="0%" y1="0%" x2="0%" y2="100%">
    <stop offset="0%" stop-color="#5C7E95"/>
    <stop offset="100%" stop-color="#3E5A6E"/>
  </linearGradient>
</defs>
<rect fill="url(#slateGrad)" rx="3" .../>
```
...
<defs>
  <filter id="shadow" x="-20%" y="-20%" width="140%" height="140%">
    <feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#232220" flood-opacity="0.1"/>
  </filter>
</defs>
...
2. [ ] Background rect fills with #ECEAE2 (paper-alt) or #FAF9F5 (washi) — never pure white
